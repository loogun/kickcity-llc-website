      ...
      <section className="pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-24">
        {BRANDS.map((brand) => (
          <div key={brand.id} className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start">
            ...
            <div className="w-full md:w-80 h-64 md:h-80 shrink-0 bg-[#C9B99A] border border-black/10 flex items-center justify-center p-8">
              <div className="text-center space-y-2">
                <p className="text-sm font-semibold uppercase tracking-widest text-black/60">Logo Placement</p>
